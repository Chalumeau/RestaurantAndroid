...
internal class ViewPagerAdapter (var context: Context, var images: List<String>) : PagerAdapter(){
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        var view = layoutInflater.inflate(R.layout.image_ressource, container,false)
        val img : ImageView =view.findViewById<ImageView>(R.id.imageView)

        if(images[position]!="") {
            Picasso.get()
                .load(images[position])
                .error(R.drawable.burger_maison) //burger
                .into(img)
            ...
            img.setImageResource(R.drawable.saumon_gravlax) //saumon
        }
